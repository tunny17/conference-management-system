...
export const previewConferences = [
  {
    text: 'ICTAS 2019',
...
export const videoUrls = ['https://www.w3schools.com/html/mov_bbb.mp4'];

export const gallery = [
  {
    id: 1,
    title: 'ALLoT2023 Photos',
    size: '12.6 MB',
    pictures: [
      '/2023/2023-1.png',
      '/2023/2023-2.png',
...
export const speakers = [
  '/speakers/speaker-1.png',
  '/speakers/speaker-2.png',
  '/speakers/speaker-3.png',
  '/speakers/speaker-4.png',
  '/speakers/speaker-5.png',
  '/speakers/speaker-6.png',
  '/speakers/speaker-1.png',
  '/speakers/speaker-1.png'
];
...
export const donationAmount = ['$10', '$20', '$30', '$40', '$50'];
export const type = ['Online Donation', 'Offline Donation'];
...
export const authorRegistration = [
  {
    ...
    sales: [
      {
        members: 'IEEE Members',
        amount: 700,
        expire: 'Regular (After 2nd May, 2024)',
        caption: 'Basic features for up to 100 users.',
        moreFeatures: [
...
export const attendeeRegistration = [
  {
    ...
    sales: [
      {
        members: 'IEEE Student Non-member',
        amount: 700,
        expire: 'Regular (After 2nd May, 2024)',
        caption: 'Basic features for up to 100 users.',
        moreFeatures: [
      ...
      {
        members: 'IEEE Student Member/Life ',
        amount: 800,
        expire: 'Regular (After 2nd May, 2024)',
        caption: 'Basic features for up to 100 users.',
        moreFeatures: [
